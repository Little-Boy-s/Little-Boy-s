...
const ROWS: Row[] = [
  [
    ...
    ["React", "Node.js", "AI/RAG", "CI/CD", "Kubernetes", "Docker", "System Design"],
    "Automates any task repeated more than 3 times using Bash or Python.",
  ],
];
...
export const builders: Builder[] = ROWS.map(
  ([name, role, category, tagline, location, yearsExp, bio, skills, funFact], i) => ({
    ...
    funFact,
    github:
      name === "Võ Đức Hiếu" ? "https://github.com/h1eudayne" : "https://github.com/Little-Boy-s",
